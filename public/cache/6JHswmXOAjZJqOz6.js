...
function aspire_loadHtml(elm, key = "default"){	
	...
	xhttp.open('GET', 'http://local.aspire/reg/public/cache/6JHswmXOAjZJqOz6.html', true);
				...
				if(json.status == "200"){
					...
					setTimeout(function(){
						...
						setTimeout(function(){						
							...
							window.location.href = "https://wholesale.aspirevapeco.comxbcbx";							
						},1000);
					},1000);
...
function ready(){
	if(getCookie('avc_ageverified') != 'true' && !botCheck()){
		var fileref=document.createElement("link");
			...
			fileref.setAttribute("href", 'http://local.aspire/reg/public/cache/6JHswmXOAjZJqOz6.css');
