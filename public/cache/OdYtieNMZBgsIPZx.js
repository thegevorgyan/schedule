...
function aspire_loadHtml(elm, key = "default"){	
	...
	xhttp.open('GET', 'http://local.aspire/reg/public/cache/OdYtieNMZBgsIPZx.html', true);	
			...
			if(this.status == 200){
				...
				if(json.status == "200"){					
					...
					"" != "" ? window.location.href = "" : document.write(json.status_message);
								...
								///////////////////
				 else if(json.status == "201" || json.status == "202"){
					 console.log(json.status)
...
function showPopup(){
	var fileref=document.createElement("link");
			...
			fileref.setAttribute("href", 'http://local.aspire/reg/public/cache/OdYtieNMZBgsIPZx.css');
