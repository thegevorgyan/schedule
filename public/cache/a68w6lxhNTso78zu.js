...
function aspire_loadHtml(elm, key = "default"){	
	...
	xhttp.open('GET', 'http://local.aspire/reg/public/cache/a68w6lxhNTso78zu.html', true);	
...
function aspire_processData(val){
	...
	xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
	console.log('http://local.aspire/reg/public/check?' + collectedDataString);
	xhttp.onreadystatechange = function() {
...
function showPopup(){
	var fileref=document.createElement("link");
			...
			fileref.setAttribute("href", 'http://local.aspire/reg/public/cache/a68w6lxhNTso78zu.css');
