...
function aspire_loadHtml(elm, key = "default"){	
	...
	xhttp.open('GET', 'http://local.aspire/reg/public/cache/ZajuPQUpITmNv7aY.html', true);
...
function ready(){
	...
	if(getCookie('aspire_token') != null && !botCheck()){		
		...
		var fileref=document.createElement("link");
			...
			fileref.setAttribute("href", 'http://local.aspire/reg/public/cache/ZajuPQUpITmNv7aY.css');
